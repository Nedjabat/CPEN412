...
{
    char test_option, select_pattern;
    ...
    while (1) {
        ...
        while (test_option != (char)('X')) {
            ...
            if ((test_option != (char)('A') && test_option != (char)('B') && test_option != (char)('C')) || test_option == (char)('X')) {
                printf("\r\nInvalid Selection\r\n");
                test_option = (char)('X');
            }
        }
        ...
        while (select_pattern != (char)('X')) {
            ...
            if ((select_pattern != (char)('A') && select_pattern != (char)('B') && select_pattern != (char)('C') && select_pattern != (char)('D')) || select_pattern == (char)('X')) {
                printf("\r\nInvalid Selection\r\n");
                select_pattern = (char)('X');
            }
        }
