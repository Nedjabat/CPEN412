...
int main(int argc, char *argv[])
{
  ...
  if((SourceFilePtr =  fopen("C:\\M68kV6.0 - 800by480\\Programs\\final-snake-game.hex", "r")) == NULL)	{
		fprintf(stderr, "Cannot Open S-Record File 'C:\\M68kV6.0 - 800by480\\Por\\mk68kdebuggerasn5.hex' for conversion to '.MIF' format\n") ;
		fprintf(stderr, "Hit any key to exit.....") ;
		getch() ;
		return 0 ;
	}
	
	if((DestFilePtr = fopen("C:\\M68kV6.0 - 800by480\\Programs\\final-snake-game.mif","w")) == NULL)	{
