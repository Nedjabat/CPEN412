; C:\M68KV6.0 - 800BY480\PROGRAMS\DEBUGMONITORCODE\M68KDEBUGMEMORYTEST.C - Compiled by CC68K  Version 5.00 (c) 1991-2005  Peter J. Fondse
...
; unsigned int data_type_num, test_data_num;
; char c;
; char* StartPtrByte = 0, * EndPtrByte = 0, * TempPtrByte = 0;
       clr.l     D4
       moveq     #0,D7
       clr.l     -42(A6)
; short int* StartPtrWord = 0, * EndPtrWord = 0, * TempPtrWord = 0;
       clr.l     D3
       clr.l     D6
       clr.l     -38(A6)
; int* StartPtrLongWord = 0, * EndPtrLongWord = 0, * TempPtrLongWord = 0;
       clr.l     D2
       clr.l     D5
       clr.l     -34(A6)
; unsigned char test_data_byte[] = { 0xAA, 0xBB, 0xCC, 0xDD };
       move.l    A3,A0
       lea       MemoryTest_test_data_byte.L,A1
       move.l    (A1)+,(A0)+
; unsigned short int test_data_word[] = { 0xAAAA, 0xBBBB, 0xCCCC, 0xDDDD };
       lea       -26(A6),A0
       lea       MemoryTest_test_data_word.L,A1
       move.l    (A1)+,(A0)+
       move.l    (A1)+,(A0)+
; unsigned int test_data_long_word[] = { 0xAAAAAAAA, 0xBBBBBBBB, 0xCCCCCCCC, 0xDDDDDDDD };
       lea       -18(A6),A0
       lea       MemoryTest_test_data_long_word.L,A1
       moveq     #3,D0
       move.l    (A1)+,(A0)+
       dbra      D0,*-2
; unsigned char progress_display_increment = 5;
       move.b    #5,-1(A6)
; printf("\r\nEnter the value below for the size of the test you would like to use?\n1 = bytes (8 bits)\n2 = words (16 bits)\n3 = long words (32 bits)\n");
       pea       @m68kde~3_162.L
       jsr       (A2)
       addq.w    #4,A7
; scanf("%d", &data_type_num);
       pea       -52(A6)
       pea       @m68kde~3_163.L
       jsr       (A5)
       addq.w    #8,A7
...
; printf("1 = \"AA\"\n2 = \"BB\"\n3 = \"CC\"\n4 = \"DD\"\n");
       ...
       jsr       (A2)
       addq.w    #4,A7
; scanf("%d", &test_data_num);
       pea       -48(A6)
       pea       @m68kde~3_167.L
       jsr       (A5)
       addq.w    #8,A7
; printf("Please enter the start address you would like to use for the test data into memory\n");
       pea       @m68kde~3_168.L
       jsr       (A2)
       addq.w    #4,A7
; StartPtrByte = Get8HexDigits(0);
       clr.l     -(A7)
       jsr       (A4)
       addq.w    #4,A7
       move.l    D0,D4
; printf("Please enter the end address you would like to use for the test data in memory\n");
       pea       @m68kde~3_169.L
       jsr       (A2)
       addq.w    #4,A7
; EndPtrByte = Get8HexDigits(0);
       clr.l     -(A7)
       jsr       (A4)
       addq.w    #4,A7
       move.l    D0,D7
...
; printf("\r\nFilling Addresses [$%08X - $%08X] with $%02X", StartPtrByte, EndPtrByte, test_data_byte[test_data_num - 1]);
       ...
       jsr       (A2)
       add.w     #16,A7
; *StartPtrByte++ = test_data_byte[test_data_num - 1];
       move.l    -48(A6),D0
       subq.l    #1,D0
       move.l    D4,A0
       addq.l    #1,D4
       move.b    0(A3,D0.L),(A0)
; if (StartPtrByte - TempPtrByte == progress_display_increment) {
       move.l    D4,D0
       sub.l     -42(A6),D0
       move.b    -1(A6),D1
       and.l     #255,D1
...
MemoryTest_13:
       ...
       tst.l     D0
       beq       MemoryTest_15
; printf("Please enter the start address you would like to use for the test data into memory (Ensure to enter an even number)\n");
       pea       @m68kde~3_176.L
       jsr       (A2)
       addq.w    #4,A7
...
; if (StartPtrWord % 2 != 0) {
       ...
       tst.l     D0
       beq.s     MemoryTest_16
; printf("ERROR: The address you have entered is not even. Please try again");
       pea       @m68kde~3_177.L
       jsr       (A2)
       addq.w    #4,A7
MemoryTest_16:
...
MemoryTest_18:
       ...
       tst.l     D0
       beq       MemoryTest_20
; printf("Please enter the end address you would like to use for the test data in memory (Ensure to enter an even number)\n");
       pea       @m68kde~3_178.L
       jsr       (A2)
       addq.w    #4,A7
...
; printf("\r\nFilling Addresses [$%08X - $%08X] with $%04X", StartPtrWord, EndPtrWord, test_data_byte[test_data_num - 1]);
       ...
       jsr       (A2)
       add.w     #16,A7
; *StartPtrWord++ = test_data_byte[test_data_num - 1];
       move.l    -48(A6),D0
       subq.l    #1,D0
       move.b    0(A3,D0.L),D0
       and.w     #255,D0
       ...
       addq.l    #2,D3
       move.w    D0,(A0)
; if (StartPtrWord - TempPtrWord == progress_display_increment) {
       move.l    D3,D0
       sub.l     -38(A6),D0
       lsr.l     #1,D0
       move.b    -1(A6),D1
...
; printf("\r\nFilling Addresses [$%08X - $%08X] with $%08X", StartPtrLongWord, EndPtrLongWord, test_data_byte[test_data_num - 1]);
       ...
       jsr       (A2)
       add.w     #16,A7
; *StartPtrLongWord++ = test_data_byte[test_data_num - 1];
       move.l    -48(A6),D0
       subq.l    #1,D0
       move.b    0(A3,D0.L),D0
       and.l     #255,D0
       ...
       addq.l    #4,D2
       move.l    D0,(A0)
; if (StartPtrLongWord - TempPtrLongWord == progress_display_increment) {
       move.l    D2,D0
       sub.l     -34(A6),D0
       lsr.l     #2,D0
       move.b    -1(A6),D1
...
@m68kde~3_166:
       dc.b      49,32,61,32,34,65,65,34,10,50,32,61,32,34,66
       dc.b      66,34,10,51,32,61,32,34,67,67,34,10,52,32,61
       dc.b      32,34,68,68,34,10,0
@m68kde~3_167:
       dc.b      37,100,0
@m68kde~3_168:
       dc.b      80,108,101,97,115,101,32,101,110,116,101,114
       ...
       dc.b      116,111,32,109,101,109,111,114,121,10,0
@m68kde~3_169:
       dc.b      80,108,101,97,115,101,32,101,110,116,101,114
       dc.b      32,116,104,101,32,101,110,100,32,97,100,100
       dc.b      114,101,115,115,32,121,111,117,32,119,111,117
       dc.b      108,100,32,108,105,107,101,32,116,111,32,117
       dc.b      115,101,32,102,111,114,32,116,104,101,32,116
       dc.b      101,115,116,32,100,97,116,97,32,105,110,32,109
       dc.b      101,109,111,114,121,10,0
@m68kde~3_170:
       dc.b      13,10,70,105,108,108,105,110,103,32,65,100,100
       dc.b      114,101,115,115,101,115,32,91,36,37,48,56,88
       dc.b      32,45,32,36,37,48,56,88,93,32,119,105,116,104
       dc.b      32,36,37,48,50,88,0
@m68kde~3_171:
       dc.b      13,10,70,73,76,76,73,78,71,32,65,100,100,114
       dc.b      101,115,115,101,115,32,91,36,37,48,56,88,32
       dc.b      45,32,36,37,48,56,88,93,32,119,105,116,104,32
       dc.b      36,37,48,50,88,0
@m68kde~3_172:
       dc.b      10,89,111,117,32,104,97,118,101,32,115,101,108
       dc.b      99,116,101,100,32,116,111,32,117,115,101,32
       dc.b      119,111,114,100,32,115,105,122,101,32,100,97
       dc.b      116,97,32,116,111,32,116,101,115,116,32,121
       dc.b      111,117,114,32,109,101,109,111,114,121,10,0
@m68kde~3_173:
       dc.b      79,117,116,32,111,102,32,116,104,101,32,98,101
       dc.b      108,111,119,32,101,120,97,109,112,108,101,32
       ...
       dc.b      112,108,101,58,10,0
@m68kde~3_174:
       dc.b      49,32,61,32,34,65,65,65,65,34,10,50,32,61,32
       dc.b      34,66,66,66,66,34,10,51,32,61,32,34,67,67,67
       dc.b      67,34,10,52,32,61,32,34,68,68,68,68,34,10,0
@m68kde~3_175:
       dc.b      37,100,0
@m68kde~3_176:
       dc.b      80,108,101,97,115,101,32,101,110,116,101,114
       ...
       dc.b      117,115,101,32,102,111,114,32,116,104,101,32
       dc.b      116,101,115,116,32,100,97,116,97,32,105,110
       dc.b      116,111,32,109,101,109,111,114,121,32,40,69
       dc.b      110,115,117,114,101,32,116,111,32,101,110,116
       dc.b      101,114,32,97,110,32,101,118,101,110,32,110
       dc.b      117,109,98,101,114,41,10,0
@m68kde~3_177:
       dc.b      69,82,82,79,82,58,32,84,104,101,32,97,100,100
       dc.b      114,101,115,115,32,121,111,117,32,104,97,118
       dc.b      101,32,101,110,116,101,114,101,100,32,105,115
       dc.b      32,110,111,116,32,101,118,101,110,46,32,80,108
       dc.b      101,97,115,101,32,116,114,121,32,97,103,97,105
       dc.b      110,0
@m68kde~3_178:
       dc.b      80,108,101,97,115,101,32,101,110,116,101,114
       dc.b      32,116,104,101,32,101,110,100,32,97,100,100
       ...
       dc.b      115,101,32,102,111,114,32,116,104,101,32,116
       dc.b      101,115,116,32,100,97,116,97,32,105,110,32,109
       dc.b      101,109,111,114,121,32,40,69,110,115,117,114
       dc.b      101,32,116,111,32,101,110,116,101,114,32,97
       dc.b      110,32,101,118,101,110,32,110,117,109,98,101
       dc.b      114,41,10,0
@m68kde~3_179:
       dc.b      69,82,82,79,82,58,32,84,104,101,32,97,100,100
       dc.b      114,101,115,115,32,121,111,117,32,104,97,118
...
@m68kde~3_183:
       ...
       dc.b      112,108,101,58,10,0
@m68kde~3_184:
       dc.b      49,32,61,32,34,65,65,65,65,65,65,65,65,34,10
       dc.b      50,32,61,32,34,66,66,66,66,66,66,66,66,34,10
       dc.b      51,32,61,32,34,67,67,67,67,67,67,67,67,34,10
       dc.b      52,32,61,32,34,68,68,68,68,68,68,68,68,34,10
       dc.b      0
@m68kde~3_185:
       dc.b      37,100,0
@m68kde~3_186:
...
@m68kde~3_191:
       ...
       dc.b      36,37,48,50,88,0
@m68kde~3_192:
       dc.b      10,89,111,117,32,102,97,105,108,101,100,32,116
       dc.b      111,32,115,101,108,101,99,116,32,97,32,100,97
       dc.b      116,97,32,116,121,112,101,32,116,111,32,117
       dc.b      115,101,33,32,67,108,105,99,107,32,114,101,115
       dc.b      101,116,32,98,117,116,116,111,110,32,116,111
       dc.b      32,114,101,115,101,116,0
@m68kde~3_193:
...
MemoryTest_test_data_byte:
       dc.b      170,187,204,221
       section   data
MemoryTest_test_data_word:
       dc.w      43690,48059,52428,56797
MemoryTest_test_data_long_word:
       dc.l      -1431655766,-1145324613,-858993460,-572662307
       section   bss
       xdef      _i
_i:
       ds.b      4
