; C:\M68KV6.0 - 800BY480\PROGRAMS\DEBUGMONITORCODE\M68KDEBUG-NO-DISASSEMBLER-WITH-NO-ADDRESS-LOGIC.C - Compiled by CC68K  Version 5.00 (c) 1991-2005  Peter J. Fondse
...
; //Program from RAM to SPI flash chip
; WriteSPIFlashData(0, 0x08000000, 256 * 1000);
       pea       256000
       pea       134217728
       clr.l     -(A7)
...
LoadFromFlashChip_1:
       cmp.l     #256000,D2
       bge.s     LoadFromFlashChip_3
; *Memaddress = ReadSPIFlashByte(count);
       move.l    D2,-(A7)
       jsr       _ReadSPIFlashByte
       addq.w    #4,A7
       move.l    D3,A0
...
; //
; // ReadSPIFlashData(0, 0x08000000, 256 * 1000);
; }
; //////////////////////////////////////////////////////////////////////////////////////////////////
; // IMPORTANT
...
menu_49:
; }
; else if (c == (char)('3')){  //I2C Page Write
       cmp.b     #51,D2
       bne.s     menu_51
; PageWriteI2C();
       jsr       _PageWriteI2C
...
menu_51:
; }
; else if (c == (char)('4')){  //I2C Sequential Read
       cmp.b     #52,D2
       bne.s     menu_53
; SeqReadI2C();
       jsr       _SeqReadI2C
...
menu_53:
; }
; else if (c == (char)('5')){  //ADC/DAC Operation
       cmp.b     #53,D2
       bne.s     menu_55
; DACWrite();
       jsr       _DACWrite
...
menu_55:
; }
; else if (c == (char)('6')){  //ADC/DAC Operation
       cmp.b     #54,D2
       bne.s     menu_57
; ADCWrite();
       jsr       _ADCWrite
...
; printf("\nYou have selcted to use bytes size data to test your memory\n");
       ...
       jsr       (A2)
       addq.w    #4,A7
; printf("Out of the below example test data, please select one by entering the value associated to each example:\n");
       pea       @m68kde~3_141.L
       jsr       (A2)
       addq.w    #4,A7
; printf("1 = \"AA\"\n2 = \"AB\"\n3 = \"CC\"\n4 = \"CD\"\n");
...
; StartPtrByte = (int)Get8HexDigits(0);
       ...
       addq.w    #4,A7
       move.l    D0,D5
; if(StartPtrByte < (int)(0x09000000) || StartPtrByte > (int)(0x09800000)){
       cmp.l     #150994944,D5
       blo.s     MemoryTest_26
       cmp.l     #159383552,D5
       bls.s     MemoryTest_24
...
MemoryTest_24:
       ...
       bhi       MemoryTest_22
; }
; } while(StartPtrByte < (int)(0x09000000) || StartPtrByte > (int)(0x09800000));
...
; EndPtrByte = (int)Get8HexDigits(0);
       ...
       addq.w    #4,A7
       move.l    D0,-64(A6)
; if(EndPtrByte < (int)(0x09000000) || EndPtrByte > (int)(0x09800000)){
       move.l    -64(A6),D0
       cmp.l     #150994944,D0
       blo.s     MemoryTest_31
       move.l    -64(A6),D0
...
MemoryTest_29:
       ...
       bhi       MemoryTest_27
; }
; } while(EndPtrByte < (int)(0x09000000) || EndPtrByte > (int)(0x09800000));
; printf("\r\n\r\nWriting to memory");
       pea       @m68kde~3_149.L
       jsr       (A2)
       addq.w    #4,A7
...
; StartPtrWord = Get8HexDigits(0);
       ...
       addq.w    #4,A7
       move.l    D0,D4
; while(StartPtrWord < (int)(0x09000000) || StartPtrWord > (int)(0x09800000)){
MemoryTest_55:
       cmp.l     #150994944,D4
       blo.s     MemoryTest_58
       cmp.l     #159383552,D4
...
; EndPtrWord = Get8HexDigits(0);
       ...
       addq.w    #4,A7
       move.l    D0,A4
; while(EndPtrWord < (int)(0x09000000) || EndPtrWord > (int)(0x09800000)){
MemoryTest_63:
       move.l    A4,D0
       cmp.l     #150994944,D0
       blo.s     MemoryTest_66
...
; StartPtrLongWord = Get8HexDigits(0);
       ...
       addq.w    #4,A7
       move.l    D0,D3
; while(StartPtrLongWord < (int)(0x09000000) || StartPtrLongWord > (int)(0x09800000)){
MemoryTest_92:
       cmp.l     #150994944,D3
       blo.s     MemoryTest_95
       cmp.l     #159383552,D3
...
; EndPtrLongWord = Get8HexDigits(0);
       ...
       addq.w    #4,A7
       move.l    D0,D7
; while(EndPtrLongWord < (int)(0x09000000) || EndPtrLongWord > (int)(0x09800000)){
MemoryTest_100:
       cmp.l     #150994944,D7
       blo.s     MemoryTest_103
       cmp.l     #159383552,D7
       bls.s     MemoryTest_102
MemoryTest_103:
; printf("\r\nERROR: End Address is outside of 68K memory range. Please try again and ensure the address is withn 0x09000000 - 0x097FFFFF\r\n");
       pea       @m68kde~3_162.L
       jsr       (A2)
...
; if(EndPtrLongWordTruc - StartPtrLongWordTruc < 4){
       ...
       sub.l     -48(A6),D0
       cmp.l     #4,D0
       bge.s     MemoryTest_116
; StartPtrWord = StartPtrLongWord;
       move.l    D3,D4
       bra.s     MemoryTest_118
MemoryTest_116:
; }else{
; if (*StartPtrLongWord != test_data_long_word) {
       move.l    D3,A0
       cmp.l     (A0),D6
       beq.s     MemoryTest_118
...
; Address = Get8HexDigits(0);
       ...
       addq.w    #4,A7
       move.l    D0,D2
; if(Address > 131071 ){ //Chip is 128kB therefore can not be greater
       cmp.l     #131071,D2
       bls.s     WriteI2C_1
...
; c = Get2HexDigits(0);
       ...
       addq.w    #4,A7
       move.b    D0,D5
; if(Address > 65535){ //Chip is consisted of 2 x 64kB blocks which is the high and low block
       cmp.l     #65535,D2
       bls       WriteI2C_4
; //Adjusting address values to high block and onwards
; AddressMSB = ((Address - 0x10000) >> 8) & 0xFF;
       move.l    D2,D0
       sub.l     #65536,D0
       lsr.l     #8,D0
       and.l     #255,D0
       move.b    D0,D4
; AddressLSB = (Address - 0x10000) & 0xFF;    
       move.l    D2,D0
       sub.l     #65536,D0
       and.l     #255,D0
       move.b    D0,D3
; WriteI2CInteraction(1, Address, AddressMSB, AddressLSB, c, 0);
       clr.l     -(A7)
       and.l     #255,D5
       move.l    D5,-(A7)
       and.l     #255,D3
...
; AddressLSB = Address & 0xFF;
       ...
       and.l     #255,D0
       move.b    D0,D3
; WriteI2CInteraction(0, Address, AddressMSB, AddressLSB, c, 0);
       clr.l     -(A7)
       and.l     #255,D5
       move.l    D5,-(A7)
       and.l     #255,D3
...
; AddressLSB = (Address - 0x10000) & 0xFF;    
       ...
       and.l     #255,D0
       move.b    D0,D3
; ReadI2CByteInteraction(1, Address, AddressMSB, AddressLSB);
       and.l     #255,D3
       move.l    D3,-(A7)
       and.l     #255,D4
       move.l    D4,-(A7)
...
; AddressLSB = Address & 0xFF;
       ...
       and.l     #255,D0
       move.b    D0,D3
; ReadI2CByteInteraction(0, Address, AddressMSB, AddressLSB);
       and.l     #255,D3
       move.l    D3,-(A7)
       and.l     #255,D4
       move.l    D4,-(A7)
...
_PageWriteI2C:
       ...
       movem.l   D2/D3/A2,-(A7)
       lea       _printf.L,A2
; unsigned int AddressFrom;
; unsigned int AddressTo;
; unsigned char c;
; printf("\r\nI2C Page Write:");
       pea       @m68kde~3_175.L
       jsr       (A2)
...
; printf("\r\nEnter Address From: ");
       ...
       jsr       (A2)
       addq.w    #4,A7
; AddressFrom = Get8HexDigits(0);
       clr.l     -(A7)
       jsr       _Get8HexDigits
       addq.w    #4,A7
       move.l    D0,D3
; if(AddressFrom > 131071 ){ //Chip is 128kB therefore can not be greater
       cmp.l     #131071,D3
       bls.s     PageWriteI2C_1
; printf("\r\nEntered Address is invalid, please enter a smaller valued address. Returning back to the debug monitor menu");
       pea       @m68kde~3_172.L
       jsr       (A2)
       addq.w    #4,A7
...
; printf("\r\nEnter Address To: ");
       ...
       jsr       (A2)
       addq.w    #4,A7
; AddressTo = Get8HexDigits(0);
       clr.l     -(A7)
       jsr       _Get8HexDigits
       addq.w    #4,A7
       move.l    D0,D2
; if(AddressTo > 131071 ){ //Chip is 128kB therefore can not be greater
       cmp.l     #131071,D2
       bls.s     PageWriteI2C_4
; printf("\r\nEntered Address is invalid, please enter a smaller valued address. Returning back to the debug monitor menu");
       pea       @m68kde~3_172.L
       jsr       (A2)
       addq.w    #4,A7
; return;
       bra.s     PageWriteI2C_3
PageWriteI2C_4:
; } 
; printf("\r\nEnter Data: ");
       pea       @m68kde~3_173.L
...
; c = Get2HexDigits(0);
       ...
       addq.w    #4,A7
       move.b    D0,-1(A6)
; PageWriteI2CInteraction(AddressFrom, AddressTo, c);
       move.b    -1(A6),D1
       and.l     #255,D1
       move.l    D1,-(A7)
       move.l    D2,-(A7)
       move.l    D3,-(A7)
       jsr       _PageWriteI2CInteraction
       add.w     #12,A7
; return;
PageWriteI2C_3:
       movem.l   (A7)+,D2/D3/A2
...
SeqReadI2C_4:
; } 
; if(AddressFrom > 65535){ //Chip is consisted of 2 x 64kB blocks which is the high and low block
       cmp.l     #65535,D2
       ble.s     SeqReadI2C_6
; ReadI2CSequential(1, AddressTo, AddressFrom, AddressFrom);
       move.l    D2,-(A7)
       move.l    D2,-(A7)
       move.l    D3,-(A7)
       pea       1
       jsr       _ReadI2CSequential
       add.w     #16,A7
       bra.s     SeqReadI2C_7
SeqReadI2C_6:
; }else{
; ReadI2CSequential(0, AddressTo, AddressFrom, AddressFrom);
       move.l    D2,-(A7)
       move.l    D2,-(A7)
       move.l    D3,-(A7)
       clr.l     -(A7)
...
; char* BugMessage = "DE1-68k Bug V1.77";
       lea       @m68kde~3_179.L,A0
       move.l    A0,D3
; char* CopyrightMessage = "Copyright (C) PJ Davies 2016";
       lea       @m68kde~3_180.L,A0
       move.l    A0,-8(A6)
; char* NameAndStudentNumber = "\r\n\r\nMatthew Tong - 59264408";
       lea       @m68kde~3_181.L,A0
       move.l    A0,-4(A6)
; KillAllBreakPoints();
       jsr       _KillAllBreakPoints
...
@m68kde~3_22:
       ...
       dc.b      103,32,83,80,73,32,70,108,97,115,104,46,46,46
       dc.b      46,0
@m68kde~3_23:
       dc.b      13,10,84,104,101,32,118,97,108,117,101,32,37
       dc.b      120,32,97,116,32,97,100,100,114,101,115,115
       dc.b      32,37,120,32,105,110,32,83,68,82,65,77,32,105
       dc.b      115,32,110,111,116,32,101,113,117,97,108,32
       dc.b      116,111,32,116,104,101,32,118,97,108,117,101
       dc.b      32,37,120,32,97,116,32,70,108,97,115,104,32
       dc.b      65,100,100,114,101,115,115,32,37,120,0
@m68kde~3_24:
       dc.b      13,10,65,108,108,32,97,100,100,114,101,115,115
       dc.b      101,115,32,104,97,118,101,32,98,101,101,110
       dc.b      32,99,111,112,105,101,100,32,105,110,116,111
       dc.b      32,83,80,73,32,70,108,97,115,104,32,99,111,114
       dc.b      114,101,99,116,108,121,0
@m68kde~3_25:
...
@m68kde~3_26:
       dc.b      13,10,80,114,111,103,114,97,109,32,100,111,110
       dc.b      101,32,108,111,97,100,105,110,103,0
@m68kde~3_27:
...
@m68kde~3_138:
       ...
       dc.b      41,32,58,0
@m68kde~3_139:
       dc.b      13,10,69,110,116,101,114,32,116,104,101,32,118
       dc.b      97,108,117,101,32,98,101,108,111,119,32,102
       dc.b      111,114,32,116,104,101,32,115,105,122,101,32
       dc.b      111,102,32,116,104,101,32,116,101,115,116,32
       dc.b      121,111,117,32,119,111,117,108,100,32,108,105
       dc.b      107,101,32,116,111,32,117,115,101,63,10,49,32
       dc.b      61,32,98,121,116,101,115,32,40,56,32,98,105
       dc.b      116,115,41,10,50,32,61,32,119,111,114,100,115
       dc.b      32,40,49,54,32,98,105,116,115,41,10,51,32,61
       dc.b      32,108,111,110,103,32,119,111,114,100,115,32
       dc.b      40,51,50,32,98,105,116,115,41,10,0
@m68kde~3_140:
       dc.b      10,89,111,117,32,104,97,118,101,32,115,101,108
       dc.b      99,116,101,100,32,116,111,32,117,115,101,32
       dc.b      98,121,116,101,115,32,115,105,122,101,32,100
       dc.b      97,116,97,32,116,111,32,116,101,115,116,32,121
       dc.b      111,117,114,32,109,101,109,111,114,121,10,0
@m68kde~3_141:
       dc.b      79,117,116,32,111,102,32,116,104,101,32,98,101
       dc.b      108,111,119,32,101,120,97,109,112,108,101,32
       dc.b      116,101,115,116,32,100,97,116,97,44,32,112,108
       dc.b      101,97,115,101,32,115,101,108,101,99,116,32
       dc.b      111,110,101,32,98,121,32,101,110,116,101,114
       dc.b      105,110,103,32,116,104,101,32,118,97,108,117
       dc.b      101,32,97,115,115,111,99,105,97,116,101,100
       dc.b      32,116,111,32,101,97,99,104,32,101,120,97,109
       dc.b      112,108,101,58,10,0
@m68kde~3_142:
...
@m68kde~3_143:
       dc.b      13,10,69,82,82,79,82,58,32,89,111,117,32,104
       dc.b      97,118,101,32,101,110,116,101,114,101,100,32
       dc.b      97,32,107,101,121,98,111,97,114,100,32,105,110
       dc.b      112,117,116,32,116,104,97,116,32,100,111,101
       dc.b      115,32,110,111,116,32,97,115,115,111,99,105
       dc.b      97,116,101,100,32,119,105,116,104,32,97,110
       dc.b      32,111,112,116,105,111,110,32,97,98,111,118
       dc.b      101,44,32,112,108,101,97,115,101,32,116,114
       dc.b      121,32,97,103,97,105,110,13,10,0
@m68kde~3_144:
       dc.b      13,10,69,82,82,79,82,58,32,79,112,116,105,111
       dc.b      110,32,109,101,109,111,114,121,32,99,111,109
       dc.b      112,108,105,99,97,116,105,111,110,46,32,69,120
...
@m68kde~3_145:
       ...
       dc.b      114,32,116,104,101,32,115,116,97,114,116,32
       dc.b      97,100,100,114,101,115,115,32,121,111,117,32
       dc.b      119,111,117,108,100,32,108,105,107,101,32,116
       dc.b      111,32,117,115,101,32,102,111,114,32,116,104
       dc.b      101,32,116,101,115,116,32,100,97,116,97,32,105
       dc.b      110,116,111,32,109,101,109,111,114,121,13,10
       dc.b      0
@m68kde~3_146:
...
@m68kde~3_147:
       dc.b      13,10,80,108,101,97,115,101,32,101,110,116,101
       dc.b      114,32,116,104,101,32,101,110,100,32,97,100
       dc.b      100,114,101,115,115,32,121,111,117,32,119,111
       dc.b      117,108,100,32,108,105,107,101,32,116,111,32
       dc.b      117,115,101,32,102,111,114,32,116,104,101,32
       dc.b      116,101,115,116,32,100,97,116,97,32,105,110
       dc.b      32,109,101,109,111,114,121,13,10,0
@m68kde~3_148:
...
@m68kde~3_150:
       dc.b      13,10,87,82,73,84,69,58,32,91,37,48,50,88,32
...
@m68kde~3_155:
       ...
       dc.b      108,99,116,101,100,32,116,111,32,117,115,101
       dc.b      32,119,111,114,100,32,115,105,122,101,32,100
       dc.b      97,116,97,32,116,111,32,116,101,115,116,32,121
       dc.b      111,117,114,32,109,101,109,111,114,121,0
@m68kde~3_156:
       dc.b      13,10,79,117,116,32,111,102,32,116,104,101,32
       dc.b      98,101,108,111,119,32,101,120,97,109,112,108
       dc.b      101,32,116,101,115,116,32,100,97,116,97,44,32
       dc.b      112,108,101,97,115,101,32,115,101,108,101,99
       dc.b      116,32,111,110,101,32,98,121,32,101,110,116
       dc.b      101,114,105,110,103,32,116,104,101,32,118,97
       dc.b      108,117,101,32,97,115,115,111,99,105,97,116
       dc.b      101,100,32,116,111,32,101,97,99,104,32,101,120
       dc.b      97,109,112,108,101,58,0
@m68kde~3_157:
...
@m68kde~3_158:
       ...
       dc.b      111,32,117,115,101,32,102,111,114,32,116,104
       dc.b      101,32,116,101,115,116,32,100,97,116,97,32,105
       dc.b      110,116,111,32,109,101,109,111,114,121,32,40
       dc.b      69,110,115,117,114,101,32,116,111,32,101,110
       dc.b      116,101,114,32,97,110,32,101,118,101,110,32
       dc.b      110,117,109,98,101,114,41,13,10,0
@m68kde~3_159:
       dc.b      13,10,69,82,82,79,82,58,32,83,116,97,114,116
       dc.b      105,110,103,32,65,100,100,114,101,115,115,32
       dc.b      105,115,32,111,117,116,115,105,100,101,32,111
...
@m68kde~3_161:
       ...
       dc.b      117,115,101,32,102,111,114,32,116,104,101,32
       dc.b      116,101,115,116,32,100,97,116,97,32,105,110
       dc.b      32,109,101,109,111,114,121,32,40,69,110,115
       dc.b      117,114,101,32,116,111,32,101,110,116,101,114
       dc.b      32,97,110,32,101,118,101,110,32,110,117,109
       dc.b      98,101,114,41,13,10,0
@m68kde~3_162:
       dc.b      13,10,69,82,82,79,82,58,32,69,110,100,32,65
       dc.b      100,100,114,101,115,115,32,105,115,32,111,117
       dc.b      116,115,105,100,101,32,111,102,32,54,56,75,32
...
@m68kde~3_165:
       dc.b      13,10,89,111,117,32,104,97,118,101,32,115,101
       dc.b      108,99,116,101,100,32,116,111,32,117,115,101
       dc.b      32,98,121,116,101,115,32,115,105,122,101,32
       dc.b      100,97,116,97,32,116,111,32,116,101,115,116
       dc.b      32,121,111,117,114,32,109,101,109,111,114,121
       dc.b      0
@m68kde~3_166:
...
@m68kde~3_171:
       dc.b      13,10,73,50,67,32,87,114,105,116,101,58,0
@m68kde~3_172:
       dc.b      13,10,69,110,116,101,114,101,100,32,65,100,100
       dc.b      114,101,115,115,32,105,115,32,105,110,118,97
       dc.b      108,105,100,44,32,112,108,101,97,115,101,32
       dc.b      101,110,116,101,114,32,97,32,115,109,97,108
       dc.b      108,101,114,32,118,97,108,117,101,100,32,97
       dc.b      100,100,114,101,115,115,46,32,82,101,116,117
       dc.b      114,110,105,110,103,32,98,97,99,107,32,116,111
       dc.b      32,116,104,101,32,100,101,98,117,103,32,109
       dc.b      111,110,105,116,111,114,32,109,101,110,117,0
@m68kde~3_173:
       dc.b      13,10,69,110,116,101,114,32,68,97,116,97,58
       dc.b      32,0
@m68kde~3_174:
       dc.b      13,10,73,50,67,32,82,101,97,100,58,0
@m68kde~3_175:
       dc.b      13,10,73,50,67,32,80,97,103,101,32,87,114,105
       dc.b      116,101,58,0
@m68kde~3_176:
       dc.b      13,10,69,110,116,101,114,32,65,100,100,114,101
       dc.b      115,115,32,70,114,111,109,58,32,0
@m68kde~3_177:
       dc.b      13,10,69,110,116,101,114,32,65,100,100,114,101
       dc.b      115,115,32,84,111,58,32,0
@m68kde~3_178:
       dc.b      13,10,73,50,67,32,83,101,113,32,82,101,97,100
       dc.b      58,0
@m68kde~3_179:
...
@m68kde~3_180:
       ...
       dc.b      49,54,0
@m68kde~3_181:
       dc.b      13,10,13,10,77,97,116,116,104,101,119,32,84
       dc.b      111,110,103,32,45,32,53,57,50,54,52,52,48,56
       dc.b      0
@m68kde~3_182:
...
_TempString:
       ds.b      100
       xref      _PageWriteI2CInteraction
       xref      _WriteI2CInteraction
       xref      _strcpy
       xref      LDIV
       xref      _go
       xref      _EraseSPIFlashChip
       xref      _ReadI2CByteInteraction
       xref      _putch
       xref      _getch
       xref      _I2C_Init
       xref      _tolower
       xref      _sprintf
       xref      _WriteSPIFlashData
       xref      _ReadI2CSequential
       xref      _strcat
       xref      _toupper
       xref      _ReadSPIFlashByte
       xref      _ADCWrite
       xref      _DACWrite
       xref      ULDIV
       xref      _printf
