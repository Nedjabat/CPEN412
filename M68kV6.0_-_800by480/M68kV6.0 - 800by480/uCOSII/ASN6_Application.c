...
void Task1(void *pdata)
{
    ...
    for (;;) {
        ...
        //Did not use PortB because this register only interacts for LED8 and LED9 which is not enough to  present 8-bit HEX value, it will just look odd
        count++;
...
void Task2(void *pdata)
{
    ...
    for (;;) {
        ...
        HEX_A = HEX_B = HEX_C = ((count << 4) + (count & 0x0f));
        count++;
...
{
    for (;;) {
    printf("........This is Task #3........but does nothing\n");
    OSTimeDly(50);
    }
}
...
{
    for (;;) {
    printf("............This is Task #4........but does nothing\n");
    OSTimeDly(50);
    }
}