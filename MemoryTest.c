...
void MemoryTest(void)
{
    ...
    while(!test_option){
        ...
        if((test_option != '1' && test_option != '2' && test_option != '3') || test_option == NULL){
            printf("\r\nInvalid Selection\r\n");
            test_option = 0;
            FlushKeyboard();
        }
    ...
    while(!select_pattern){
        ...
        select_pattern = _getch();

        if((select_pattern != '1' && select_pattern != '2' && select_pattern != '3' && select_pattern != '4') || select_pattern == NULL){
            printf("\r\nInvalid Selection\r\n");
            select_pattern = 0;
            FlushKeyboard();
        }
