...
; start_addr = Get8HexDigits(0);
       ...
       addq.w    #4,A7
       move.l    D0,D3
; if(start_addr<0xf0000000 || start_addr>0xf3ffffff){
       cmp.l     #-268435456,D3
       blo.s     MemoryTest_42
       cmp.l     #-201326593,D3
       bls.s     MemoryTest_40
...
; end_addr = Get8HexDigits(0);
       ...
       addq.w    #4,A7
       move.l    D0,D5
; if(end_addr<start_addr || end_addr>0xf3ffffff){
       cmp.l     D3,D5
       blo.s     MemoryTest_50
       cmp.l     #-201326593,D5
       bls.s     MemoryTest_48
...
@m68kde~1_148:
       ...
       dc.b      109,32,102,48,48,48,32,48,48,48,48,32,116,111
       dc.b      32,102,51,102,102,32,102,102,102,102,13,10,0
@m68kde~1_149:
...
@m68kde~1_152:
       ...
       dc.b      116,111,32,102,51,102,102,32,102,102,102,102
       dc.b      13,10,0
@m68kde~1_153:
...
@m68kde~1_160:
       ...
       dc.b      46,13,10,0
@m68kde~1_161:
       dc.b      67,80,69,78,52,49,50,32,45,32,76,97,98,32,50
       dc.b      0
@m68kde~1_162:
